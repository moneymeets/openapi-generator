...
public class SharedTypeScriptTest {
    ...
    public void oldImportsStillPresentTest() throws IOException {
        ...
        Assert.assertTrue(apiFileContent.contains("import { Category, ModelFieldsCategory, modelFieldsCategory }"));
        Assert.assertTrue(apiFileContent.contains("import { Tag, ModelFieldsTag, modelFieldsTag }"));
